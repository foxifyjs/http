...
export default class Request extends IncomingMessage {
  public readonly method!: MethodT;
  public readonly url!: string;
  public readonly headers!: HeadersI;

  public readonly statusCode: undefined;
  public readonly statusMessage: undefined;
  ...
  public get query(): Record<string, unknown> {
    return (
      this._queryCache ||
      (this._queryCache = SETTINGS["query.parser"](
        (this._parsedUrl || (this._parsedUrl = parseUrl(this.url))).query!,
      ))
    );
  }
